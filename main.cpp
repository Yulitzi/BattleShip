...
/* 
 * File:   main.cpp
 * Author: Vincent Melendrez
 * Created on March 18th, 2019, 12:31 PM
 ...
 * TODO:
 *  Allow user to input in VERTICAL format (rotate)                     COMPLETE
 *  If tile is occupied, output an error and have them retry            COMPLETE
 *  If input is out of bounds, output an error and have them retry      COMPLETE
 *  Create AI to create their own board and play against player
 *      Place ships with random values                                  COMPLETE
 ...
 * -    Still encountering out of bounds error when generating AI Table
 * -        Might just restrict the boundaries from 1 - 7 rather 1 - 8
 * -    Displays amount of ship tiles each side has
